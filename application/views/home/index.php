...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="<?= base_url(); ?>assets/template/dist/favicon.ico" />
    <!-- Bootstrap icons-->
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="<?= base_url('auth')?>">Login</a>
                </div>
            </div>
        </div>
    </nav>
